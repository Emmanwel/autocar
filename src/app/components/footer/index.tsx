    ...
    <FooterContainer>
      <InnerContainer>
        <AboutContainer>
          ...
          <AboutText>
            AutoCar is a Car renting and selling company located in many
        ...
        <SectionContainer>
          ...
          <HorizontalContainer>
            ...
            <SmallText>+253 704 576 324</SmallText>
          </HorizontalContainer>
        </SectionContainer>
        <SectionContainer>
          ...
          <HorizontalContainer>
            ...
            <SmallText>info@mukhebi.com</SmallText>
          </HorizontalContainer>
        </SectionContainer>
      </InnerContainer>
      <BottomContainer>
        <CopyrightText>
          Copyright &copy; {new Date().getFullYear()} AutoCar. All rights
          reserved.
        </CopyrightText>
      </BottomContainer>
    </FooterContainer>
